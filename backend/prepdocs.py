...
from azure.identity.aio import AzureDeveloperCliCredential, get_bearer_token_provider, ManagedIdentityCredential, DefaultAzureCredential
...
if __name__ == "__main__":
    ...
    # )
    #azd_credential = ManagedIdentityCredential()
