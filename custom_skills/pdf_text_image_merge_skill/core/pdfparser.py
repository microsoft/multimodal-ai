...
from azure.ai.documentintelligence.models import DocumentTable, AnalyzeDocumentRequest
...
class DocumentAnalysisParser(Parser):
    ...
    async def parse(self, url: str) -> AsyncGenerator[Page, None]:
        logging.info(f"Extracting text from '{url}' using Azure Document Intelligence")
